...
//    { label: 'Acceleration torque', value: results.accelerationTorque.toFixed(0), unit: 'Н⋅м' },
//    { label: 'dynamicTorqueA', value: results.dynamicTorqueA.toFixed(3), unit: 'Н⋅м' },
//    { label: 'constantLoadTorque', value: results.constantLoadTorque.toFixed(3), unit: 'Н⋅м' },
