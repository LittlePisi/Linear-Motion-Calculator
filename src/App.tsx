    ...
    <div className={`min-h-screen transition-colors duration-200 ${
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className={`mt-8 rounded-xl shadow-lg p-6 ${
          ...
          <p>• Калькулятор расчитывает профиль перемещения и требуемый крутящий момент на основе введенных параметров системы.</p>
          <p>• Расчёт учитывает перемещаемую массу, постоянную подачи привода, внешнюю инерционную нагрузку, моменты и усилия сопротивления и передаточное число редуктора при вычислении.</p>
